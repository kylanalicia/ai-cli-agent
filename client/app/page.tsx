    ...
    <div className="flex min-h-screen items-center justify-center bg-background font-sans">
      <div className="w-full max-w-md px-4">
        <div className="space-y-8">
          ...
          {/* UserDetails Card */}
          <div className="border-2 border-dashed border-zinc-700 rounded-2xl p-6 bg-zinc-900/50 background-blur-sm space-y-4">
          ...
          className="w-full h-11 bg-red-600 hover:hg-red-700 text-white font-semibold rounded-lg transition-colors">
            Sign Out
          </Button>
          {/* Decorative divider */}
