...
const DeviceAuthorizationPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
        ...
        className="border-2 border-dashed border-zinc-700 rounded-xl p-8 bg-zinc-950 background-blur-sm">
            <div className="space-y-6">
                ...
                <div>
                    ...
                    maxLength={9}
                    className="w-full px-4 py-3 bg-zinc-900 border-2 border-dashed border-zinc-700 rounded-lg
                    text-foreground placeholder-muted-foreground focus:outline-none focus:border-zinc-600
                ...
                className="w-full py-3 px-4 bg-zinc-100 text-zinc-950 font-semibold rounded-lg hover:bg-zinc-200
                ...
                <div className="p-4 bg-zinc-900 border-2 border-dashed border-zinc-700 rounded-lg">
                    <p className="text-xs text-muted-foreground loading-relaxed">
                        This code is unique to your device and will expire shortly. Keep it confidential and 
                        never share it with 
                        anyone.
                        </p>
                </div>
